"""
Django settings for narrativestudio project.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-lookhere-self-portrait-studio-secret-key-2025')
...
INSTALLED_APPS = [
    'bookings',  # Must be before django.contrib.admin to override templates
...
if _database_url:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'photobooth_db'),
...
# Note: STATICFILES_STORAGE is set inside the Cloudinary block below if Cloudinary is active
# Otherwise default whitenoise storage is used via STORAGES dict
...
# Cloudinary - permanent media storage for production
...
GOOGLE_CALENDAR_CREDENTIALS = BASE_DIR / os.environ.get('GOOGLE_CALENDAR_CREDENTIALS', 'google_credentials.json')
